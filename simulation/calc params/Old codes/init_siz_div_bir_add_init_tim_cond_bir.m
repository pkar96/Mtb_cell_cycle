...
% initiation. More stringent conditions on
% initiation length i.e., it can happen after one of the concurrent 
% processes (from birth) is complete.

function [dist] = init_siz_div_bir_add_init_tim_cond_bir(params, observed_data, num, num_med)
...
bii= params(2); % num(num_in,23); %5.3 change in volume from initiation to initiation
